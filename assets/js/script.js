//questions: -How to make google maps qpi work for multiple requests?
//-How to re-order the list of shelters. 
//-do we have anchors added to the list of shelters? i guess it works regardless, goes to petfinder which is fine. 
//Getting rid of the "we found shelters near you...etc" using hide class that we add/remove in the for loop
...
function initMap() {
  ...
  const city = new google.maps.LatLng(place.geometry.location.lat, place.geometry.location.lng);
...
function search(event) {
  ...
  fetch("https://api.petfinder.com/v2/oauth2/token", {
    ...
    .then(() => {
      ...
      fetch(`https://api.petfinder.com/v2/organizations?&location=${cityInput.value.replace(", USA", "")}&sort=distance`, {
        method: "GET",
        mode: "cors",
        headers: {
